...
- `.env.example`;
- MariaDB razvojna baza, iste glavne verzije kao na Hetzner produkciji;
...
>
> Status 6c: završeno 25. 9. 2026. Zadaci (klijent opcion, prioritet, rok kao dan ili dan i vreme u zoni unosa, završavanje štikliranjem uz zapis ko i kada, ponovno otvaranje, soft delete), strana „Tasks“ sa tabovima otvoreni / zakasneli / danas / završeni, tab na profilu klijenta, follow-up sa strane konsultacije, zadaci na vremenskoj liniji (dodavanje i završetak); dashboard sa terminima danas i narednih 7 dana, zakasnelim, današnjim i narednim zadacima, nedavno aktivnim klijentima, novim fajlovima i klijentima bez potpunih podataka rođenja. Time je Faza 6 završena; uplate, prihod, podsetnici i tranziti na dashboardu idu u Fazu 7.
