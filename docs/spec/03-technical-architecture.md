...
- ciljna verzija: aktuelna LTS grana koju nudi Hetzner (10.11 ili 11.4); tačnu verziju proveriti i upisati ovde;
- razvojna i produkcijska glavna verzija baze moraju biti iste; lokalni 10.6.5 je prelazan, jer je grana 10.6 izašla iz podrške u julu 2026;
- charset `utf8mb4`, collation `utf8mb4_unicode_ci`; engine uvek InnoDB, zadat u konfiguraciji aplikacije, ne preko podrazumevanog podešavanja servera;
...
- MariaDB 10.6.5 na portu `3307`, baza `astrolabe_online__10_2026`, test baza `astrolabe_online__10_2026_test` — uskladiti sa Hetzner verzijom pre ozbiljnijih migracija;
