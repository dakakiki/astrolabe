...
// ISO 3166-1 alpha-2 codes, from GeoNames countryInfo.txt. Names are shown in the
// viewer's language by the browser (Intl.DisplayNames), so only codes live here.
...
return [
    ...
    'CG', 'CH', 'CI', 'CK', 'CL', 'CM', 'CN', 'CO', 'CR', 'CS', 'CU', 'CV', 'CW', 'CX',
