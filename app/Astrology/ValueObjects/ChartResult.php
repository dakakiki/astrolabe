...
/**
 * An engine's answer: positions, the angles and houses when they were asked
 * for, plus what produced them, so a stored chart can always say which engine
 * and ephemeris files it came from (docs/spec/02).
 */
